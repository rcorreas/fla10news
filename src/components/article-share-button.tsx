...
export function ArticleShareButton({ title, slug, type = 'noticias' }: { title: string, slug: string, type?: 'noticias' | 'colunas' | 'videos' | 'flahistoria' | 'voz-torcedor' | 'galeria' | 'raio-x' | 'tirinhas' }) {
    ...
    const getTypeText = () => {
        switch (type) {
            ...
            case 'tirinhas': return 'a tirinha';
