...
import { ArrowLeft, Menu, Newspaper, Users, Video, Trophy, Shield, ChevronDown, LayoutGrid, ScanLine, Palette, MessageSquare, Smile } from 'lucide-react'
...
const navLinks = [
  ...
  { href: '/tirinhas', label: 'Fla10 Tirinhas', icon: Smile },
]
