          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-2">
             ...
             <div className="grid gap-2">
                ...
                <Textarea id="content" name="content" placeholder="Escreva a raio-x completa aqui. Você pode usar tags HTML como <p>, <h3> e <strong> para formatar o texto." className="min-h-[300px]" required />
            </div>
          </CardContent>
          <CardFooter>
            <SubmitButton />
